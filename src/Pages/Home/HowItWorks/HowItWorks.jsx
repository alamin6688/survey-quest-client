const HowItWorks = () => {
    ...
    return (
      <section className="bg-[#1F2937] pt-12 pb-16 px-5 mt-20 rounded-xl">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold text-gray-900">5. Step 5: Take Action</h3>
            <p className="mt-2 text-gray-600">
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-semibold text-gray-900">6. Feedback & Improvements</h3>
            <p className="mt-2 text-gray-600">
